  ...
  return ( <div className="px-4 xl:px-6">
    ...
    <div className="flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px]    pt-2 dark:border-stroke-dark md:items-center"> 
      ...
      <div className="flex items-center gap-2">
        <button className="text-gray-500 hover:text-gray-600 dark-neutral-500 dark:hover:text-gray-300"> 
        ...
        <div className="relative">
          <input type="text" placeholder="Search Task"
             className="rounnded-md border py-1 pl-10 pr-4 focus:outline-none dark:border-dark-secondary dark:bg-dark-secondary dark:text-white"/>
